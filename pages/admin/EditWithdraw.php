                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Mã QR</label>
                                <div class="col-sm-10">
                                    <img src="https://api.vietqr.io/<?=$row['nganhang'];?>/<?=$row['sotaikhoan'];?>/<?=$row['sotien'];?>/NHANTHECAO thanh toan/vietqr_net_2.jpg?accountName=<?=$row['chutaikhoan'];?>"/>
                                </div>
                            </div>
                            <div class="form-group row">
